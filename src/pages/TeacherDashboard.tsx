...
import AcademicManagement from '@/components/teacher/AcademicManagement';
...
const TeacherDashboard = () => {
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-[#3A3F6B] mt-2 font-bold opacity-70">Monitor and manage your teacher dashboard.</p>
        </div>
        <div className="flex items-center gap-3 bg-white/40 backdrop-blur-md px-5 py-2.5 rounded-full border border-white/50 shadow-sm">
          ...
          <span className="text-[10px] font-black text-[#3A3F6B] uppercase tracking-[0.15em]">Active</span>
        </div>
      </div>
  ...
  const renderContent = () => {
    switch (activeView) {
      ...
      case 'management': return <AcademicManagement />;
